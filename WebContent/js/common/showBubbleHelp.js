 ...
 * @ProcessChain   : Reuse
 *
 * @File           : ShowBubbleHelp.js
 *
 * @FileName       : 풍선도움말 기능 설정
 *
 * Open Issues     :
 *
 * Change history
 * @LastModifyDate : 2003.05.12
 * @Author         : 정소희
 * @LastModifier    : 
 *     2003.09.18    정창호
 *     1.0       VAUTO default 설정
 * @LastModifier   : 정소희
 * @LastVersion    : draft1A
 *     2003.05.12    정소희
 *     draft1A       for review
 ...
 *
 *  여기서 선택하여 바꾼 것이 html page에서 설정되어 보여짐.
 **---------------------------------------------------------------------------------------------------*/
...
/**
* @Function 명		: tooltipOn
* @Function 설명	: onMouseOver 이벤트가 일어나면 옵션에 따라 해당하는 풍선도움말을 생성한다.
* @Param 			: 
* @return값			: boolean
* @사용 Event 		: onMouseOver
* @see 				:
*/
...
/**
* @Function 명		: tooltipOff
* @Function 설명	: onMouseOut 이벤트가 일어나면 바로 생성한 풍선도움말을 없앤다.
* @Param 			: 
* @return값			: boolean
* @사용 Event 		: onMouseOut
* @see 				:
...
/**
* @Function 명		: overlib350
* @Function 설명	: 풍선도움말 생성시 설정해둔 옵션에 맞는 형태로 맞춰준다.
* @Param 			: 
* @return값			: boolean
* @사용 Event 		: 
* @see 				:
...
/**
* @Function 명		: ol_content_simple
* @Function 설명	: 제목(Caption)이 없는 단순한 형태의 풍선도움말 옵션.
* @Param 			: text
* @return값			: text
* @사용 Event 		: 
* @see 				:
...
/**
* @Function 명		: ol_content_caption
* @Function 설명	: 제목(Caption)이 있으며 Close로 사라지게 하는 링크가 걸린 형태의 풍선도움말 옵션.
* @Param 			: text, title, close
* @return값			: text
* @사용 Event 		: 
* @see 				:
*/
...
/* default로 VAUTO(자동 vertical 계산을 통해 Layer때문에 스크롤 생김 방지 (2003-09-18) */
...
/**
* @Function 명		: mouseMove
* @Function 설명	: 마우스 커서의 좌표값에 따라 레이어도 움직이게 함.
* @Param 			: event
* @return값			: 
* @사용 Event 		: 
* @see 				:
